...
exclude-result-prefixes="fo">
  ...
  <xsl:template match="hawb">
    ...
    <fo:block-container height="39mm" width="100mm" left="0mm" top="38mm" position="absolute">
       <xsl:call-template name="sndr_addr"/>
    </fo:block-container>
	
    <fo:block-container height="43mm" width="94mm" left="103mm" top="38mm" position="absolute">
      <xsl:call-template name="dest_addr"/>
    </fo:block-container>

    <fo:block-container height="11mm" width="100mm" left="0mm" top="78.5mm" position="absolute">
       <xsl:call-template name="job_details_prompt"/>
    </fo:block-container>
	
    <fo:block-container height="11mm" width="94mm" left="103mm" top="78.5mm" position="absolute">
...
<!-- -->
  ...
  <!--<xsl:template name="logo">
    <fo:block>
      <xsl:variable name="imagepath" select="concat('file:',image_path,'tcc_ant_logo_pdf.jpg')"/>
  ...
  <xsl:template name="logo">
    <fo:block>
      <xsl:variable name="imagepath" select="concat('file:',/netc/hawb/image_path,'/tcc_ant_logo_pdf.jpg')"/>
    ...
    <fo:block font-size="7pt" width="67mm">
      <fo:table border="solid .3pt #000000" table-layout="fixed" width="67mm" line-height="90%">
        ...
        <fo:table-body>
          ...
          <fo:table-row >
            <fo:table-cell><fo:block font-weight="bold" padding-top="2pt">&#160;DATE </fo:block></fo:table-cell>
            <fo:table-cell>
              <fo:block font-weight="bold" padding-top="2pt"> &#160;<xsl:value-of select="cs_bkdt"/></fo:block>
            </fo:table-cell>
          </fo:table-row>
          <fo:table-row>
            <fo:table-cell font-weight="bold" padding-top="2pt"><fo:block>&#160;WEIGHT </fo:block></fo:table-cell>
            <fo:table-cell>
              <fo:block font-weight="bold" padding-top="2pt"> &#160;<xsl:value-of select="cs_twgt"/>&#160;kgs </fo:block>
            </fo:table-cell>
          </fo:table-row>
          <fo:table-row>
            <fo:table-cell font-weight="bold" padding-bottom="2px"><fo:block padding-top="2pt">&#160;NUMBER OF PIECES </fo:block></fo:table-cell>
            <fo:table-cell>
              <fo:block font-weight="bold" padding-top="2pt"> &#160;<xsl:value-of select="cs_nopg"/></fo:block>
            </fo:table-cell>
          </fo:table-row>
        </fo:table-body>
      </fo:table>
...
border-bottom-color="#000000" border-bottom-style="solid">
                  ...
                  <fo:table-row height="24mm">
					...
					<fo:block>
                      <fo:block-container height="24mm" width="86mm" line-height="85%">  
                      <xsl:if test="da_cnam">
                        <fo:block padding-top="0pt"><xsl:value-of select="da_cnam"/></fo:block>
                      </xsl:if>
                      <xsl:if test="da_adr1">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_adr1"/></fo:block>
                      </xsl:if>
                       <xsl:if test="da_adr2">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_adr2"/></fo:block>
                      </xsl:if>
                      <xsl:if test="da_adr3">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_adr3"/></fo:block>
                      </xsl:if>
                      <xsl:if test="da_adr4">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_adr4"/></fo:block>
                      </xsl:if>
                       <xsl:if test="da_zpcd">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_zpcd"/></fo:block>
                      </xsl:if>
                       <xsl:if test="da_adr5">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_adr5"/></fo:block>
                      </xsl:if>
                       <xsl:if test="da_cocd">
                        <fo:block padding-top="2pt"><xsl:value-of select="da_co_desc"/></fo:block>
                      </xsl:if>
                      </fo:block-container>
					  </fo:block>
                    </fo:table-cell>
                  ...
                  <fo:table-row font-size="6pt" height="7.9mm">
                    <fo:table-cell  padding-left="5pt" border-top=".3pt solid #000000" border-right=".3pt solid #000000">
                      <fo:block font-size="4.5pt" text-align="left" padding-top="2pt">P.O. BOX ADDRESSES WILL REQUIRE RECIPIENT'S 
PHONE 
NUMBER</fo:block>
                      <fo:block text-align="left" padding-top="1pt">PHONE/FAX NO.: <fo:inline font-weight="bold">
                        <xsl:value-of select="da_phon"/></fo:inline>
                      </fo:block>
                    </fo:table-cell>
                    <fo:table-cell   font-size="5pt" padding-left="2pt" border-top=".3pt solid #000000" >
              ...
              <fo:table table-layout="fixed" >
                ...
                <fo:table-body>
                  <fo:table-row height="5mm" display-align="center" text-align="left" >
                    <fo:table-cell font-size="6pt" padding-left="2pt" border-bottom-width=".3pt" border-bottom-color="#000000" border-bottom-style="solid">
                      <fo:block overflow="hidden" wrap-option="no-wrap">
                        FROM: <fo:inline><xsl:value-of select="bookby/contact"/> </fo:inline>
                      </fo:block>
</fo:table-cell>
					<fo:table-cell font-size="6pt" padding-left="2pt" border-bottom-width=".3pt" border-bottom-color="#000000" border-bottom-style="solid">
                      <fo:block overflow="hidden" wrap-option="no-wrap">
                  ...
                  <fo:table-row height="24mm" >
                    <fo:table-cell  font-size="7pt" padding-left="10pt" padding-top="5pt" number-columns-spanned="2">
					<fo:block>
                     <fo:block-container height="24mm" width="93mm" line-height="85%" >
                      <xsl:if test="bookby/contact">
                        <fo:block padding-top="0pt"><xsl:value-of select="bookby/contact"/></fo:block>
                      </xsl:if>

                      <xsl:if test="ca_cnam">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_cnam"/></fo:block>
                      </xsl:if>
                      <xsl:if test="ca_adr1">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_adr1"/></fo:block>
                      </xsl:if>
                      <xsl:if test="ca_adr2">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_adr2"/></fo:block>
                      </xsl:if>
                      <xsl:if test="ca_adr3">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_adr3"/></fo:block>
                      </xsl:if>
                      <xsl:if test="ca_adr4">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_adr4"/></fo:block>
                      </xsl:if>
                      <xsl:if test="ca_zpcd">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_zpcd"/></fo:block>
                      </xsl:if>
                      <xsl:if test="ca_cocd">
                        <fo:block padding-top="2pt"><xsl:value-of select="ca_co_desc"/></fo:block>
                      </xsl:if>
                      </fo:block-container>
					  </fo:block>
                    </fo:table-cell>
      ...
      <fo:table table-layout="fixed">
        ...
        <fo:table-body>
          <fo:table-row height="19mm">
            ...
            <fo:table-cell border=".3pt solid #000000">
			<fo:block>
                ...
                <fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							...
							<xsl:if test="sl_desc">
							  <fo:table-row height="5mm">
								<fo:table-cell padding-left="3mm" padding-right="1mm" padding-bottom="1mm">
								  <fo:block text-align="left" padding-top="1pt">
							  ...
							  <fo:table-row>                    
								<fo:table-cell padding-left="3mm" padding-right="1mm" padding-bottom="1mm">
								  <fo:block text-align="left" padding-top="1pt">
									...
									<fo:inline><xsl:value-of select="cs_spin"/></fo:inline>
								  </fo:block> 
								</fo:table-cell>
							  </fo:table-row>
							</xsl:if>
