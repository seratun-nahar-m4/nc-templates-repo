          ...
          <fo:table-row >
            ...
            <fo:table-cell
              ...
              <fo:table table-layout="fixed">
                ...
                <fo:table-body>
                  <fo:table-row height="4mm" display-align="center" text-align="left">
...
<fo:table-cell font-size="6pt" padding-left="2pt" border-bottom-width=".3pt" border-bottom-color="#000000" border-bottom-style="solid">
                  ...
                  <fo:table-row >
					...
					<fo:block>
                     <fo:block-container height="23mm" width="93mm" line-height="100%">
                      <xsl:if test="ca_cnam">
                  ...
                  <fo:table-row height="9.9mm" >
                    ...
                    <fo:table-cell   background-color="#D5E2E8" padding-left="5pt"
